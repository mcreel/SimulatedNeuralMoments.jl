...
**NOTE: the main branch recently moved to a new API. The DSGE and SV examples work, but MN is not yet adapted, nor is the documentation. For simple examples that work in their entirety, and correct documentation, get the 0.2 release.**
